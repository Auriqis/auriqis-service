    ...
    <section className="flex min-h-screen items-center justify-center px-6">
      <div className="relative flex flex-col items-center gap-12">
        ...
        >
          ...
          <p className="max-w-md text-sm leading-relaxed text-muted-foreground text-center">
            A short, focused conversation to understand your goals, assess feasibility, and identify the fastest path forward — no sales fluff, just clarity.
          </p>
          {/* Subtle subtext */}
          <span
        ...
        >
          <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
            Have an idea, a challenge, or a system you want built faster and better?
          </p>
          <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
            Tell us what you're building, we'll help you move from concept to execution with confidence.
          </p>
